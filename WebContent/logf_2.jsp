	  ...
	  <div class="product-detail">
	  	<div class="product-image imgArea">
	  		<div class="keyImg">
		  		 <ul class="u">
		  		 	<li class="l">
		  		 		<img src="img/세트2.jpg" class="ThumbImage" alt>
		  		 	</li>
		  		 </ul>
	  		</div>
	  	</div>
	  		...
	  		<div class="infoArea">
	  			<div class="infoArea1">
	  				...
	  				<span class="simple" style="display: block;">
	  					오늘이 아니면 이 가격에 살 수 없어요 !<br> 빨리 구매하세요 ~~!
	  				</span>
	  			</div>
	  						...
	  						<tr class="판매가 record">
	  							...
	  							<td>
	  								<span style="font-size: 12px; color: #000000;">
	  									<strong id=span_product_price" style="text-decoration: line-through;">87,000원</strong>
	  						...
	  						<tr class="element product product-option record">
	  							...
	  							<td>
	  								<select name="option1" id="option_id1" class="ProductOption0" option_style="select" required="true">
	  									...
	  									<option value="진주 반지 세트" link_image>진주 반지 세트</option>
	  								</select>
	  							</td>
	  						</tr>
	  					</tbody>
