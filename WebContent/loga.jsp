...
<body>
	<div class="wrap">
		...
		<div class="container">
		  ...
		  <section>
		  <div class="neck">
		  	<h2 id="necklace" align="center">Necklace</h2>
    		...
    		<li class="item record">
    			...
    			<ul class="product-listitem">
    				...
    				<li class="record">
    					...
    					<span style="font-size: 11px; color: #ff9999;">여인의 향이 느껴지는 것 같은 ~~</span>
    				</li>
    			</ul>
    			<span class="soldCount" style="display: inline;">
    		...
    		<li class="item record">
    			...
    			<ul class="product-listitem">
    				...
    				<li class="record">
    					...
    					<span style="font-size: 11px; color: #ff9999;">"옷까지 고급져 보이는 효과 !!"<br> 카메오 목걸이로 포인트 Up!</span>
    				</li>
    			</ul>
    			<span class="soldCount" style="display: inline;">
    		...
    		<li class="item record">
    			...
    			<ul class="product-listitem">
    				...
    				<span style="font-size: 12px; color: #000000;">38,900원</span>
    				<span id="span_product" style></span>
    				</li>
    				<li class="record">
    					<strong class="title displaynone">
