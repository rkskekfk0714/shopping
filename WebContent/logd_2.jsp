	  ...
	  <div class="product-detail">
	  	<div class="product-image imgArea">
	  		<div class="keyImg">
		  		 <ul class="u">
		  		 	<li class="l">
		  		 		<img src="img/귀걸이3.jpg" class="ThumbImage" alt>
		  		 	</li>
		  		 </ul>
	  		</div>
	  	</div>
	  		...
	  		<div class="infoArea">
	  			...
	  			<span class="gSoldCount">
	  				<p class="soldCount" style="display: block;">
	  					<strong class="count">9,000</strong>
	  					구매중
	  				</p>
	  			</span>
	  						...
	  						<tr class="판매가 record">
	  							...
	  							<td>
	  								<span style="font-size: 12px; color: #000000;">
	  									<strong id="span_product_price" style="text-decoration: line-through;">38,000원</strong>
	  						...
	  						<tr class="element product product-option record">
	  							...
	  							<td>
	  								<select name="option1" id="option_id1" class="ProductOption0" option_style="select" required="true">
	  									...
	  									<option value="크리스탈로 제작한 물방울 귀걸이" link_image>크리스탈로 제작한 물방울 귀걸이</option>
	  								</select>
	  							</td>
	  						</tr>
	  					</tbody>
