		...
		<div id="contentWrap">
			<div id="content1">
				...
				<div class="container">
				    <nav class="navi">
				      <ul>
				        <li><a href="a.jsp">목걸이</a></li>
				        <li><a href="b.jsp">팔찌</a></li>
				        <li><a href="c.jsp">반지</a></li>
				        <li><a href="d.jsp">귀걸이</a></li>
				        <li><a href="e.jsp">브로치</a></li>
				        <li><a href="f.jsp">기타</a></li>
				      </ul>
				    </nav>  
			 	 </div>
							...
							<table summary="번호, 사진, 제품명, 수량, 적립, 가격, 배송비, 취소">
								...
								<tbody>
									...
									<tr class="nbg">
										...
										<td>
											<div class="tb-center">
												<a href="d_2.jsp">[BEST]크리스탈로 제작한 물방울 귀걸이</a>
