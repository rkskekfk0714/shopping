    ...
    <hr width = "40px" color = "gray"; text-align= "center">
    	<ul class="prdList column4">
    		...
    		<li class="item record">
    			...
    			<span class="soldCount" style="display: inline;">
    				<strong class="count">8,200</strong>
    				구매중
    			</span>
    			</div>
    		</li> 		
    		...
    		<li class="item record">
    			...
    			<span class="soldCount" style="display: inline;">
    				<strong class="count">8,203</strong>
    				구매중
    			</span>
    			</div>
    		</li>
    		...
    		<li class="item record">
    			...
    			<span class="soldCount" style="display: inline;">
    				<strong class="count">6,001</strong>
    				구매중
    			</span>
    			</div>
    		</li>
    ...
    <hr width = "40px" color = "gray"; text-align= "center">
    	<ul class="prdList column4">
    		<li class="item record">
    			...
    			<span class="soldCount" style="display: inline;">
    				<strong class="count">1,008</strong>
    				구매중
    			</span>
    			</div>
    		</li>
    		...
    		<li class="item record">
    			...
    			<ul class="product-listitem">
    				...
    				<li class="record">
    					...
    					<span style="font-size: 11px; color: #ff9999;"> 서로 다른 색다른 디자인 ! </span>
    				</li>
    			</ul>
    			<span class="soldCount" style="display: inline;">
    				<strong class="count">1,079</strong>
    				구매중
    			</span>
    			</div>
    		</li>
