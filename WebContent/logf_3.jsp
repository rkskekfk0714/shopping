...
<body>
	<header>
	  <h1 align="center" onclick="location.href='LoginComp.jsp'"> Beads Accessories</h1>   
	  <div id="log">    
	  ...
	  <div class="product-detail">
	  	<div class="product-image imgArea">
	  		<div class="keyImg">
		  		 <ul class="u">
		  		 	<li class="l">
		  		 		<img src="img/진주1.jpg" class="ThumbImage" alt>
		  		 	</li>
		  		 </ul>
	  		</div>
	  	</div>
	  		...
	  		<div class="infoArea">
	  			<div class="infoArea1">
	  				...
	  				<span class="simple" style="display: block;">
	  					담수진주는 모양이나 크기가 균일하지 않은 천연진주 입니다.<br>
	  					광택은 있으나 표면에 다소 줄이 보일 수도 있습니다.<br>
	  					모양과 크키가 따라 갯수는 다소 차이가 있을 수 있습니다.<br>
	  					전체 길이는 38cm~ 정도로 동일합니다.
	  				</span>
	  			</div>
	  						...
	  						<tr class="판매가 record">
	  							...
	  							<td>
	  								<span style="font-size: 12px; color: #000000;">
	  									<strong id=span_product_price" style="text-decoration: line-through;">1,000원</strong>
	  						...
	  						<tr class="element product product-option record">
	  							...
	  							<td>
	  								<select name="option1" id="option_id1" class="ProductOption0" option_style="select" required="true">
	  									...
	  									<option value="원형담수진주 펄피치 5mm~6mm" link_image>원형담수진주 펄피치 5mm~6mm</option>
	  								</select>
	  							</td>
	  						</tr>
	  					</tbody>
	  				...
	  				<tfoot>
	  					...
	  					<div class="product-action">
	  						<div class="base-button action-button">
	  							<div class="buy wrap">
	  								<a href="tinecklace.jsp" class="btn buy" onclick="location.href='basket.jsp'">
	  							...
	  							<div class="basket wrap">
	  								<a href="tinecklace.jsp" class="btn basket" onlick="location.href='Order.jsp'">
	  									장바구니
	  								</a>
	  							</div>
	  						</div>
