...
<body>
	<div class="wrap">
		...
		<div class="container">
		  ...
		  <section>
		  <div class="neck">
		  	<h2 id="necklace" align="center">기타</h2>
		  	<hr width = "40px" color = "gray" text-align= "center"><br>
		  	<ul class="prdList column4">
    		<li class="item record">
    			<div class="box">
    			<img src="img/세트1.jpg" width="300" height="300">
    			<p class="name">
    				<a href="f_1.jsp">
    			...
    			<ul class="product-listitem">
    				...
    				<span style="font-size: 12px; color: #555555; text-decoration: line-through;">87,000원</span>
    				</li>
    				<li class="record">
    				<strong class="title displaynone">
    				...
    				<span style="font-size: 12px; color: #000000;">86,000원</span>
    				...
    				<li class="record">
    					...
    					<span style="font-size: 11px; color: #ff9999;"> 드디어 세트로 나왔습니다 !!<br> 같이 착용하면 더욱 이뻐지는 ㅎㅎ </span>
    				</li>
    			</ul>
    			<span class="soldCount" style="display: inline;">
    				<strong class="count">8,000</strong>
    				구매중
    			</span>
    			</div>
    		</li>
    		...
    		<li class="item record">
    			<div class="box">
    			<img src="img/세트2.jpg" width="300" height="300">
    			<p class="name">
    				<a href="f_2.jsp">
    					<strong class="title displaynone">
    						<span style="font-size: 12px; color: #555555;">상품명</span>
    			...
    			<ul class="product-listitem">
    				...
    				<span style="font-size: 12px; color: #000000;">82,000원</span>
    				<span id="span_product" style></span>
    				</li>
    				<li class="record">
    					<strong class="title displaynone">
    					...
    					<span style="font-size: 11px; color: #ff9999;">심플하면서 세련된 진주 반지를 <br> 오늘만 특가 할인 합니다!</span>
    				</li>
    			</ul>
    			<span class="soldCount" style="display: inline;">
    				<strong class="count">90,912</strong>
    				구매중
    			</span>
    			</div>
    		</li>
    		...
    		<li class="item record">
    			<div class="box">
    			<img src="img/진주1.jpg" width="300" height="300">
    			<p class="name">
    				<a href="f_3.jsp">
    					<strong class="title displaynone">
    						<span style="font-size: 12px; color: #555555;">상품명</span>
    					...
    					<span style="font-size: 12px; color: #555555;">
    						원형담수진주 펄피치 5mm~6mm(1줄:낱개 약70~80개)
    					</span>
    					<br>
    				</a>
    			</p>
    			<ul class="product-listitem">
    				...
    				<span style="font-size: 12px; color: #000000;">10,000원</span>
    				<span id="span_product" style></span>
    				</li>
    				<li class="record">
    					<strong class="title displaynone">
    					...
    					<span style="font-size: 11px; color: #ff9999;">자체제작</span>
    				</li>
    			</ul>
    			<span class="soldCount" style="display: inline;">
    				<strong class="count">907</strong>
    				구매중
    			</span>
    			</div>
    		</li>
    		...
    		<li class="item record">
    			<div class="box">
    			<img src="img/크리스탈1.jpg" width="300" height="300">
    			<p class="name">
    				<a href="f_4.jsp">
    					<strong class="title displaynone">
    						<span style="font-size: 12px; color: #555555;">상품명</span>
    					...
    					<span style="font-size: 12px; color: #555555;">
    							할인크리스탈론델 3mm-크리스탈(약145개)[핫세일,비즈반지,한정상품]
    					</span>
    					<br>
    				</a>
    			</p>
    			<ul class="product-listitem">
    				...
    				<span style="font-size: 12px; color: #555555; text-decoration: line-through;">2,000원</span>
    				</li>
    				<li class="record">
    				<strong class="title displaynone">
    					<span style="font-size: 12px; color: #000000;">판매가</span>
    				...
    				<span style="font-size: 12px; color: #000000;">1,200원</span>
    				<span id="span_product" style></span>
    				</li>
    				<li class="record">
    					<strong class="title displaynone">
